...
?>
	...
	<div class="side">
		...
		<ul>
			...
			<li><a href="https://rooms.receptionist.jp/documents/"><img src="<?php echo get_template_directory_uri(); ?>/img/meeting-room-reservation-management.webp" alt="会議室の空き状況"></a></li>
		</ul>	
