...
<!-- /ページタイトル -->
<section class="boxil">
	<h2>たくさんのお客さまに選ばれて<br><span>5つのNo.1</span>を獲得</h2>
		<ul>
			<li><img src="<?php echo get_template_directory_uri(); ?>/img/boxil01.webp" width="190.922" height="190.922" alt="Goodservice"></li>
			<li><img src="<?php echo get_template_directory_uri(); ?>/img/boxil02.webp" width="190.922" height="190.922" alt="使いやすさNo.1"></li>
			<li><img src="<?php echo get_template_directory_uri(); ?>/img/boxil03.webp" width="190.922" height="190.922" alt="機能満足度No.1"></li>
			<li><img src="<?php echo get_template_directory_uri(); ?>/img/boxil04.webp" width="190.922" height="190.922" alt="サービスの安定性No.1"></li>
			<li><img src="<?php echo get_template_directory_uri(); ?>/img/boxil05.webp" width="190.922" height="190.922" alt="カスタマイズ性No.1"></li>
			<li><img src="<?php echo get_template_directory_uri(); ?>/img/boxil06.webp" width="190.922" height="190.922" alt="お役たち度No.1"></li>
		</ul>
	<p>※1 BOXIL SaaS Award Autumn 2023「Good Service」対象期間内(2022年8月1日〜2023年7月31日)に投稿された口コミを対象に会議室予約システム部門で総得点の高いサービスに対して与えられる称号</p>
	<p>※2 「BOXIL SaaS」上に投稿された口コミを対象に「お役立ち度」「カスタマイズ性」「サービスの安定性」「機能満足度」「使いやすさ」において会議室予約システム部門で最も高い平均点を獲得したサービスをスマートキャンプ株式会社が選出（対象期間：2022年8月1日〜2023年7月31日）</p>
</section>
...
<section class="sec05 section rec-space">
		<div class="container">
			<h3 class="uk-text-center">ご利用イメージ</h3>
				<p class="rec-space_image">会議室・電話ブースなどの入退室の端末、管理画面、<br class="pc">時間お知らせ機能のイメージを掲載しております。</p>
      ...
      <div class="uk-glid uk-grid-medium card-wrap" uk-grid>
        ...
        <div class="card-box uk-width-1-4@s uk-width-1-2">
          <div class="uk-card uk-card-default uk-card-body">
            ...
            <h4 class="uk-text-center">電話ブース</h4>
          </div>
        </div>
        <div class="card-box uk-width-1-4@s uk-width-1-2">
          <div class="uk-card uk-card-default uk-card-body">
