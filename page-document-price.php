...
<!-- ページタイトル -->
<div class="hero page-title wrapper document document2">
  <div class="hero-body">
    <div class="container">
...
<?php endif; ?>
    <div class="container_r contact">
      <div class="form-wrap">
        <form id="contact" action="https://t.receptionist.jp/l/436112/2021-11-29/8j3b1b" method="post" name="document">
          <input type="hidden" name="contact_type" value="rooms_document_price">
          <div class="form-box">
...
<option value="1001名以上">1001名以上</option>
         ...
         <div class="kv-form-agree">
          ...
          <input type="submit" value="料金表を見る" id="send" class="btn btn_dl">
        </form>
        </div>
    </div>
  </div>
